...
| **Inventory / Inventar** (`/catalog`)    | Searchable, filterable, paginated inventory of data sets, IT systems, IT services and organizations as an Oblique table (default) or cards. Text cells with links, figures that roll up along the hierarchy (an organization counts the systems, data sets and services of itself and all its sub-units), postal addresses from the Zefix and Staatskalender registers on LINDAS; filters as (multi) selects in a panel like the map's; grouping by system, organization or sector; CSV export.                                                                           |
| **Details** (`/entity/:id`)              | One page per element: description, relations diagram (incoming left, outgoing right, long groups expandable), organizational structure tree (ancestors, the element, all sub-units/parts) with a per-class roll-up (systems of sub-units, data sets in sub-systems, storage of parts, users of sub-services), identifiers (Zefix, Staatskalender), legal basis, keywords                                                                                                                                                                                                  |
...
src/app/core/
  ...
  address.service.ts                 postal addresses of organizations from the Zefix / Staatskalender graphs
