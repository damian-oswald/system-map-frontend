...
| Page                                     | What it offers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Dashboard / Übersicht** (`/dashboard`) | Welcome and the three views; key figures per class (top-level elements first, their sub-units and parts beneath, a button to the inventory each) with the note that they describe what the graph has recorded so far; a locked excerpt of the map showing the FOAG system landscape with a button to the map; selected analyses (PageRank vs recorded-properties scatter with named leaders and a subgraph select, operators as columns on a log scale by sector, sectors, cantonal tile map, relation types, documented architectures); documentation completeness                                                                                                        |
...
| **Details** (`/entity/:id`)              | One page per element: a light grey banner with title, subclass tags, description, parent unit, address and website; _In Zahlen_ with figures aggregated down the hierarchy (sub-units, systems, data sets, services …); a _Kontext_ panel that embeds the map's network view around the element (1–3 steps, a click opens the neighbour's page); the hierarchy as a plain tree; and every relation of the element and its parts as a paginated subject–predicate–object table in the inventory's style.                                                                                                                                                                    |
