...
| **Inventory / Inventar** (`/catalog`)    | Searchable, filterable inventory of data sets, IT systems, IT services and organizations as an Oblique table (default) or cards. Shows where data is stored and who is responsible, as plain text with links. Filters are (multi) selects in a panel like the map's; group by system or organization; CSV export.                                                                                                                                                                                                                                                         |
